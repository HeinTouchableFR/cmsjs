...
const pdf = `<svg viewBox="0 0 32 32">
...
const doc = `<svg viewBox="0 0 16 16">
...
class DropFilesElement extends HTMLInputElement {
     ...
     */
    render() {
        const { label, help, accept } = this.getAttributes();
      ...
      <input type="file" multiple class="drop-files__fake"/>
        ...
        dom.querySelector('.drop-files__fake').accept = accept;
        return dom;
    }
