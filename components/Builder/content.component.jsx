...
export default function Content({dispositions, ajouterDisposition, modifierDisposition, supprimerDisposition}) {
    return (
        <div className={`${styles.content} ${styles.container}`}>
            {dispositions && dispositions.map(item => <Disposition key={item.id} disposition={item} modifierDisposition={modifierDisposition} supprimerDisposition={supprimerDisposition} />)}
