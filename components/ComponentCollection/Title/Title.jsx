    ...
    return (
        <>
            <Accordion active={true} title={intl.formatMessage({id: item.type, defaultMessage: item.type})}>
                <Form.Input fluid label={intl.formatMessage({id: item.type, defaultMessage: item.type})} placeholder={intl.formatMessage({id: item.type, defaultMessage: item.type})} name='text' type='text' value={item.content.text}
