...
export default function Title({element, onElementValeurChange}) {
    ...
    const fontsOptions = [
        {key: 'Roboto', text: 'Roboto', value: 'Roboto', content: (<span css={css`font-family: Roboto; font-weight: normal`}>Roboto</span>)},
        {key: 'Impact', text: 'Impact', value: 'Impact',content: (<span css={css`font-family: Impact; font-weight: normal`}>Impact</span>)},
    ]
