...
export default function TextPreview({element, device}) {
    ...
    const textStyle = function (device) {
        return {
    ...
    const textStyleHover = function (device) {
        return {
    ...
    const Text = styled.div`
            ...
            transition: 'color .2s';
            ${textStyle("desktop")}
            ${(device === "tablet" || device === "mobile") && textStyle("tablet")}
            ${device === "mobile" && textStyle("mobile")}
            &:hover {
                ${textStyleHover("desktop")}
                ${(device === "tablet" || device === "mobile") && textStyleHover("tablet")}
                ${device === "mobile" && textStyleHover("mobile")}
            };
        `
