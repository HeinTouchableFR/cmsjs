...
export default function MenuEditor({ content, onChange }) {
    ...
    const deleteItem = (arr, id) => arr.reduce((acc, item) => {
                    ...
                    <>
                        ...
                        >
                            <Accordion
                                title={(
                                    <Grid columns={2}>
                                        <Grid.Column>{item.label}</Grid.Column>
                                        <Grid.Column
                                            align='right'
                                        >
                                            {item.type}
                            ...
                            <Droppable
                                droppableId={`${item.id}`}
                                isDropDisabled={(parentIsDragging || (snapshot.isDragging ? isDisabled : false)) ? isDisabled : false}
                            >
                                {(provided, _snapshot) => (
                                    <div
                                        {...provided.droppableProps}
