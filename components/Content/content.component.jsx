...
export default function Content({titre, icon, url, action, children}) {
                ...
                <div className={styles.contentHeaderColumn}>
                    <h1 className={styles.contentHeaderTitle}>
                        ...
                        <div className={styles.content}>
                            {titre}
                            {!action &&
                                <div className={styles.contentHeaderTitleSub}>Gérer les {titre}</div>
                            }
                        </div>
                    </h1>
                    {!action &&
                        <LinkBouton url={"/admin/" + url + "/ajouter"} label={"Créer"} icon={"fa-plus"} />
                    }
                </div>
